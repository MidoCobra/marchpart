...
urlpatterns = [
    ...
    path("tires/arabiclanguage", views.Tires_arabic, name="tires_arabic"),
    path("liquids-brands/arabiclanguage", views.Liquids_brands_arabic, name="liquids_brands_arabic"),
    path("liquids-types/<int:id>/arabiclanguage", views.Liquids_types_arabic, name="liquids_types_arabic"),
    path("liquids-products/<liquid_id>/<brand_id>/arabiclanguage", views.Liquids_products_arabic, name="liquids_products_arabic"),

    path("part-brand/<int:id>/arabiclanguage", views.PartBrand_arabic, name="part-brand_arabic"),
    # path("offers-arabic", views.Offers_arabic, name="offers_arabic"),
    path("offer-products/<int:id>/arabiclanguage", views.Offer_products_arabic, name="offer_products_arabic"),

    path("Ajax/ManfactureYears_Ajax", views.ManfactureYears_Ajax, name="manfactureYears_Ajax"),
    ...
    path("arabiclanguage/merchant-form", check_recaptcha(views.Merchant_Form_arabic), name="merchant_form_arabic"),
