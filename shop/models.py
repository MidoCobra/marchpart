...
class Product(models.Model):
    ...
    name_arabic = models.CharField(max_length=100, null=True, unique=True)
    product_commercial_name = models.CharField(max_length=100, null=True)
    product_commercial_name_arabic = models.CharField(max_length=100, null=True)
    ...
    part_number = models.CharField(max_length=7, null=True)
