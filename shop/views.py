...
from .forms import ReviewProductForm, ContactUsForm, Merchant_Request_Form
...
def Home(request, category_slug=None):
    ...
    ## Temporarly code for replacing string in field
    # replaceSlash = Product.objects.filter(slug__contains= '/')
    # for i in replaceSlash:
...
def ProductSearchAllTypes(request):
    if request.GET.get('q'):
        ...
        results3 = Product.objects.filter(
            name_arabic__icontains=q).values_list('search_tags', flat=True)
...
def Merchant_Form(request):
    ...
    return render(request, "merchant-form.html", context=context)


def Offer_products(request, id):
    ...
    return render(request, 'offers_products.html', context)
...
def Tires(request):
    ...
    return render(request, 'shop/product/tires.html', context)


def Liquids_brands(request):
    ...
    return render(request, 'shop/product/liquid_brands.html', context)


def Liquids_types(request, id):
    ...
    return render(request, 'shop/product/liquid_types.html', context)


def Liquids_products(request, liquid_id, brand_id):
    ...
    return render(request, 'shop/product/liquid_products.html', context)