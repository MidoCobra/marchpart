...
urlpatterns = [
    ...
    path("tires/englishlanguage", views.Tires, name="tires"),
    path("liquids-brands/englishlanguage", views.Liquids_brands, name="liquids_brands"),
    path("liquids-types/<int:id>/englishlanguage", views.Liquids_types, name="liquids_types"),
    path("liquids-products/<liquid_id>/<brand_id>/englishlanguage", views.Liquids_products, name="liquids_products"),

    # path("offers", views.Offers, name="offers"),
    path("offer-products/<int:id>/englishlanguage", views.Offer_products, name="offer_products"),
    ...
    path("englishlanguage/merchant-form", check_recaptcha(views.Merchant_Form), name="merchant_form"),
